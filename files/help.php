...
echo ConsoleColor::getColorCode('white') . 'Доступные команды:' . PHP_EOL . PHP_EOL;
...
echo ConsoleColor::getColorCode('yellow') . 'Подробное описание основных команд и их параметров' . PHP_EOL;
echo ConsoleColor::getColorCode('white') . 'create -dr:<DocumentRoot> -url:<URL> -cms:<bitrix>' . PHP_EOL;
...
echo ConsoleColor::getColorCode('yellow') . 'Пример "create":' . PHP_EOL;
echo ConsoleColor::getColorCode('default') . 'php cli.php hostman:create -dr:/var/www/site.ru -host:site.ru -cms:bitrix' . PHP_EOL;
